...
CREATE TABLE artists_descriptions (
...
INSERT INTO
    artists_descriptions (name, description, origin, day, hour, stage)
VALUES
    (
    'Armin van Buuren',
  ...
  (
    'Disclosure (Guy et Howard Lawrence)',
  ...
  (
    'Dash Berlin (Jeffrey Sutorius, Eelke Kalberg et Sebastiaan Molijn)',
  ...
  (
    'Major Lazer (Diplo, Walshy Fire et Ape Drums)',
  ...
  (
    'The Chainsmokers (Andrew Taggart, Alex Pall et Matt McGuire)',
  ...
  (
    'Timmy Trumpet (Timothy Jude Smith)',
  ...
  (
    'Da Tweekaz (Kenth Kvien et Marcus Nordli)',
  ...
  (
    'Sub Zero Project (Nigel Coppen et Thomas Velderman)',
